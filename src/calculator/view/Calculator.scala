          ...
          scene = new Scene() {
               content = List(
                    new GridPane {
                         ...
                         //  - Cos/Sin
                         //  - Deg to rad
                         add(new CalculatorButton("+/-", new NegateAction(calculatorModel), yScale = 1), 0, 6, 1, 1)
                         add(new CalculatorButton("cos", new CosAction(calculatorModel), yScale = 1), 1, 6, 1, 1)
                         add(new CalculatorButton("sin", new SinAction(calculatorModel), yScale = 1), 2, 6, 1, 1)
                         add(new CalculatorButton("°", new DegAction(calculatorModel), yScale = 1), 3, 6, 1, 1)
